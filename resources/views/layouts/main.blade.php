            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <a href="/"><svg class="h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]"
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" @click.outside="open = false"
                                    ...
                                    <a href="/inici"
                                        class="block px-4 py-2 text-sm text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">datatables
                                        inici</a>

                                    <a href="/welcome"
                                        class="block px-4 py-2 text-sm text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">presentacio
                                        projecte</a>

                                    <a href="/gallery"
                                        class="block px-4 py-2 text-sm text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">gallery
                                        people</a>

                                    <a href="/posts/datatables"
                                        class="block px-4 py-2 text-sm text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">datatables
                                        ajax</a>

                                    <a href="/phpmyadmin"
                                        class="block px-4 py-2 text-sm text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                            ...
                            <a href="{{ url('/admin') }}"
                                class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"target="_blank">
                                admin
                            </a>
                            @auth
